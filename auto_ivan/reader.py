...
class Reader:
    ...
    def make_json(self, id_row: int) -> dict:
        ...
        employee_number_alone = self.main_data_sheet.rows[id_row].cells[3].value
        ...
        json_data = {
            "assignees": [{"employeeNumber": num} for num in employee_number_list],
